        ...
        <ul class="flex">
            <li class="pr-5 cursor-pointer links" > 
                <a href="https://www.github.com/FavourOyewumi7" target="_blank"> 
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="w-6 h-6 dark:fill-white">
            ...
            <li class="px-5 cursor-pointer links" >
                <a href="https://www.linkedin.com/in/favour-o-3610731a6/" target="_blank"> 
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-6 h-6 dark:fill-white">
            ...
            <li class="px-5 cursor-pointer links" >
                <a href="mailto:oyewumifavour65@gmail.com" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-6 h-6 dark:fill-white">
            ...
            <li class="px-5 cursor-pointer links" >
                <a href="https://instagram.com/ayomideof">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-6 h-6 dark:fill-white">
